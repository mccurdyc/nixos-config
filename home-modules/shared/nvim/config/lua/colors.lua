...
hi("DiagnosticUnnecessary", { fg = colors.yellow })
hi("DiagnosticError", { fg = colors.red, bg = "NONE" })
...
hi("Conceal", { fg = "NONE", bg = "NONE" }) -- hiding or 'concealing' characters
...
hi("@markup.raw", { fg = colors.yellow, bg = colors.dark_grey, bold = true })
hi("@markup.raw.block", { fg = colors.yellow, bg = colors.dark, bold = true })
hi("@string.special", { fg = colors.blue })
hi("markdownCode", { fg = colors.yellow })
