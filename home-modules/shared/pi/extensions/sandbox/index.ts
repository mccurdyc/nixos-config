...
// Exported so minimal-mode can import sandbox state and operations
export let sandboxEnabled = false;
export let sandboxInitialized = false;
export { createSandboxedBashOps };
...
export default function (pi: ExtensionAPI) {
	...
	// No tool registration here — minimal-mode.ts owns the bash tool override
	// and delegates to sandbox operations when sandbox is active.
